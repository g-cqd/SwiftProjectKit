...
extension DefaultConfigs {
    ...
    private static func ciWorkflowHeader() -> String {
        """
        name: CI
    ...
    private static func ciLintJob() -> String {
        """
    ...
    private static func ciBuildAndTestJob() -> String {
        """
          build-and-test:
            name: Build & Test
            runs-on: macos-15
    ...
    private static func ciCodeQLJob() -> String {
        """
          codeql:
    ...
    private static func ciPlatformMatrixJob(name: String, platforms: PlatformConfiguration) -> String {
    ...
    private static func buildPlatformEntries(platforms: PlatformConfiguration) -> [String] {
        var entries: [String] = []
...
extension DefaultConfigs {
    ...
    private static func releaseWorkflowHeader() -> String {
        """
        name: Release
    ...
    private static func releaseValidateJob() -> String {
        """
    ...
    private static func releaseChangelogJob() -> String {
        """
          changelog:
    ...
    private static func releaseCreateReleaseJob(name: String) -> String {
        """
          create-release:
            name: Create Release
            runs-on: macos-15
            ...
            steps:
              ...
              - name: Prepare Release Notes
                run: |
                  ...
                  ```swift
                  dependencies: [
                      .package(url: "https://github.com/g-cqd/\(name).git", from: "${{ needs.validate.outputs.version }}")
                  ]
                  ```
